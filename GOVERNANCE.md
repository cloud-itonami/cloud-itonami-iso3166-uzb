...
`cloud-itonami-iso3166-uzb` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
Uzbekistani-licensed counsel or a registered agent for whatever licensed
representation the law of the Republic of Uzbekistan requires for
