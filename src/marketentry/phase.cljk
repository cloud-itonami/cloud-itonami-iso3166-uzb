(ns marketentry.phase
  "Phase 0->3 staged rollout for the Republic of Uzbekistan (UZB)
  market-entry compliance actor.
    ...
    Phase 3  supervised auto  -- governor-clean, high-confidence
                                 `:engagement/intake` (no tender/
                                 xarid.uzex.uz filing risk yet) may
                                 auto-commit. `:filing/draft`/
                                 `:filing/submit` NEVER auto-commit, at
                                 any phase.
  ...
  real xarid.uzex.uz tender response / equivalent filing package and
  submitting a real filing are the two real-world acts this actor
