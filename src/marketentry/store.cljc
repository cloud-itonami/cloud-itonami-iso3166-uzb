(ns marketentry.store
  "SSoT for the Republic of Uzbekistan (UZB) market-entry compliance
...
(defn demo-data
  ...
  `:engages-local-staff-under-probation?` / `:probation-employee-
  category` / `:probation-period-months` are ground truth for the
  flagship CATEGORY-DEPENDENT STATUTORY CEILING check (Labour Code of
  the Republic of Uzbekistan Art.130 -- does a declared initial
  probation period stay within the 3-month general / 6-month senior-
  management ceiling?); `:requires-stir?` / `:stir-verified?` are
  ground truth for the conditional STIR (taxpayer identification
  number) check."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Toshkent Savdo MChJ" :procurement-channel "xarid.uzex.uz public procurement portal"
    ...
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :procurement-channel "xarid.uzex.uz public procurement portal"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :engages-local-staff-under-probation? false
             :requires-stir? true :stir-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Samarqand Eksport MChJ" :procurement-channel "xarid.uzex.uz public procurement portal"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "UZB" :status :intake}
    "eng-4" {:id "eng-4" :operator "Farg'ona Qurilish MChJ" :procurement-channel "xarid.uzex.uz public procurement portal"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :engages-local-staff-under-probation? true :probation-employee-category :general :probation-period-months 4
             :requires-stir? true :stir-verified? true
             :drafted? false :submitted? false
             :jurisdiction "UZB" :status :intake}
    "eng-5" {:id "eng-5" :operator "Buxoro Import MChJ" :procurement-channel "xarid.uzex.uz public procurement portal"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :engages-local-staff-under-probation? false
             :requires-stir? true :stir-verified? false
             :drafted? false :submitted? false
             :jurisdiction "UZB" :status :intake}
    "eng-6" {:id "eng-6" :operator "Namangan Tekstil MChJ" :procurement-channel "xarid.uzex.uz public procurement portal"
             :base-fee 400000 :monthly-rate 25000 :monitoring-months 6
             :claimed-fee 550000.0
             :engages-local-staff-under-probation? true :probation-employee-category :senior-management :probation-period-months 6
             :requires-stir? true :stir-verified? true
             :drafted? false :submitted? false
             :jurisdiction "UZB" :status :intake}}})
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/procurement-channel :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/engages-local-staff-under-probation? :engagement/probation-employee-category :engagement/probation-period-months
   :engagement/requires-stir? :engagement/stir-verified?
